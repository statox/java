...
public class Cavalier extends Piece {
	 ...
	 * @param _symbole
	 */
	public Cavalier(Coordonnees _coordonnees, Couleur _couleur,
				Boolean _estMange, ArrayList<Coordonnees> _casesJouablesVides,
				ArrayList<Coordonnees> _casesJouablesPrises) {
		
		super("Cavalier", _coordonnees, _couleur, _estMange, _casesJouablesVides, _casesJouablesPrises, "C");
	}
	...
	public void deplacementsPossibles(Echiquier e){
		...
		// creation de l'ensemble des cases ou peut potentiellement se rendre le cavalier
		cibles.add(new Coordonnees(coordPiece.get_x()+2, coordPiece.get_y()+1));
		cibles.add(new Coordonnees(coordPiece.get_x()+2, coordPiece.get_y()-1));
		cibles.add(new Coordonnees(coordPiece.get_x()-2, coordPiece.get_y()+1));
		cibles.add(new Coordonnees(coordPiece.get_x()-2, coordPiece.get_y()-1));
		cibles.add(new Coordonnees(coordPiece.get_x()+1, coordPiece.get_y()+2));
		cibles.add(new Coordonnees(coordPiece.get_x()+1, coordPiece.get_y()-2));
		cibles.add(new Coordonnees(coordPiece.get_x()-1, coordPiece.get_y()+2));
		cibles.add(new Coordonnees(coordPiece.get_x()-1, coordPiece.get_y()-2));
